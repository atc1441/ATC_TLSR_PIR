...
_attribute_ram_code_ void adc_temp_init(void)
{
	...
	*/
	...
	adc_set_ain_channel_differential_mode(ADC_MISC_CHN, TEMSENSORP, TEMSENSORN);//TEMPERATURE_SENSOR_P_EE, TEMPERATURE_SENSOR_N_EE);
...
_attribute_ram_code_ uint16_t get_temperature_c(void)
{
	...
	adc_temp_value = (signed short)(579-((adc_sample_and_get_result() * 840)>>13));
